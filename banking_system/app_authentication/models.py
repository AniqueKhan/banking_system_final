...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    self_employed = models.CharField(max_length=3, choices=SELF_EMPLOYED_MARRIAGE_CHOICES,default=SELF_EMPLOYED_MARRIAGE_CHOICES[0][0])
    married = models.CharField(max_length=3, choices=SELF_EMPLOYED_MARRIAGE_CHOICES,default=SELF_EMPLOYED_MARRIAGE_CHOICES[0][0])
    ...
    education = models.CharField(max_length=13, choices=EDUCATION_CHOICES,default=EDUCATION_CHOICES[0][0])
    applicant_income = models.FloatField()
    co_applicant_income = models.FloatField(blank=True,null=True)
    property_area = models.CharField(max_length=10,choices=PROPERTY_AREA_CHOICES,default=PROPERTY_AREA_CHOICES[0][0])
